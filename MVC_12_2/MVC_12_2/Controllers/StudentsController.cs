...
namespace MVC_12_2.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Grade,CourseID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Grade,CourseID")] Student student)
        {
            if (ModelState.IsValid)
            {
